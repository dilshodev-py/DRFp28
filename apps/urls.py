...
from apps.views import HelloTemplateView, Hello2View, ProductJsonUpdateView, \
       ...
       post_list_view, post_detail_view, product_form_view, TodoView, TodoDeleteView, login_view, \
       logout_view, TodoListView, TodoDetailView, UserListView, ProductUpdateView, ProductDeleteView, ProductFormView, \
       RegisterFormView, VerifyCodeView
...
urlpatterns = [
       ...
       path('product/form' , ProductFormView.as_view() , name='product-form')
]